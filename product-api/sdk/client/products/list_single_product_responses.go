...
import (
	...
	"github.com/seonicklaus/microservices-go/product-api/sdk/models"
)
...
func (o *ListSingleProductOK) Error() string {
	return fmt.Sprintf("[GET /product/{id}][%d] listSingleProductOK  %+v", 200, o.Payload)
}
...
func (o *ListSingleProductNotFound) Error() string {
	return fmt.Sprintf("[GET /product/{id}][%d] listSingleProductNotFound  %+v", 404, o.Payload)
}
